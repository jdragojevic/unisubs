...
urlpatterns = patterns('teams.views',
    ...
    url(r'^(?P<slug>[-\w]+)/application/approve/(?P<user_pk>\d+)/$', 'approve_application', name='approve_application'),
    url(r'^(?P<slug>[-\w]+)/application/deny/(?P<user_pk>\d+)/$', 'deny_application', name='deny_application'),
